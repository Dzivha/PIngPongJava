...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void newBall() {
        random = new Random();
        // ball = new
        // Ball((GAME_WIDTH/2)-(BALL_DIAMETER/2),(GAME_HEIGHT/2)-(BALL_DIAMETER/2),BALL_DIAMETER,
        // BALL_DIAMETER); Ball spawns at center
        // ball spawns anywhere at the center of the screen
    ...
    public void checkCollision() {
        ...
        // add Score and create new paddles and ball
        // player 1 concedes
        if (ball.x <= 0) {
            score.player2++;
            newPaddles();
